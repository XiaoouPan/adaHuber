#' @docType package
#' @name adaHuber-package
#' @title adaHuber: Adaptive Huber Estimation and Regression
#' @description Huber-type robust estimation for mean, covariance and (penalized) regression.
...
#' @references Sun, Q., Zhou, W.-X. and Fan, J. (2020). Adaptive Huber regression. J. Amer. Stat. Assoc. 115 254-265.
